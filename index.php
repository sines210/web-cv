...
<body>
    <main>
                ...
                <nav class="nav">        
                          <div id="top-content-left" class="c-desk1">
                                  <a href="img/photo_grand.png" target="blank"><img src="img/petit.png" alt="photo id" id="img-petit">  </a>
                           </div> 
                           <div id="top-content-right" class="c-mob1 c-desk1 ">
                                  <h1>Inès SOUIDI  Développeuse Web</h1>
         
                                   <div class="infos-perso">
                                             <i class="fas fa-suitcase"></i>30ans   Marseille
                                   </div>
                                  <div class="infos-perso">
                                             <i class="fas fa-phone"></i>0782185635
                                  </div>
                                  <div class="infos-perso">
                                             <i class="fas fa-envelope"></i>sines210@gmail.com
                                  </div>
                                 <div class="infos-perso git-link">
                                            <i class="fab fa-github"></i><a href="https://github.com/sines210?tab=repositories" >sines210</a> 
                                 </div>
                          </div> 
                          <div class="c-desk1 button-dark">
                                     <button class="butt">Dark mode</button>
                         </div>
                </nav>   
                ...
                <article class="container">
                              ...
                              <section class="right-side">
                                          <div class="right-cont right1">
                                                         ...
                                                         <div class="skills" id="s2">SASS</div>
                                                         <div class="skills" id="s2-5">BOOTSTRAPS </div>
                                                         <div class="skills" id="s3">JAVASCRIPT</div>
                                                         <div class="skills" id="s3-5">PHP</div>
                                                         <div class="skills" id="s4">SQL</div>
                                                         <div class="skills" id="s5">LARAVEL</div>
                                                         <div class="skills" id="s5-5">WORDPRESS</div>
